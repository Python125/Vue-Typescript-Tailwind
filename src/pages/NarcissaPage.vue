<template>
  <div>
    ...
    />
    <div class="narcissa-info flex ml-48rem">
      <div>
        <img :src="narcissaWand" alt="narcissa" class="w-96" />
        <div class="mt-0.5"></div>
      </div>
      <div class="ml-16">
        <h1 class="text-4xl text-center">Interactive Narcissa Malfoy™ Wand</h1>
      </div>

      <div class="mt-16 -ml-34.8rem">
        <div>
