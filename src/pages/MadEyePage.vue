<template>
  <div>
    ...
    />
    <div class="madEye-info flex ml-48rem">
      <div>
        <img :src="madEyeWand" alt="madeye" class="w-96" />
        <div class="mt-0.5"></div>
      </div>
      <div class="ml-16">
        <h1 class="text-4xl text-center">Interactive Mad-Eye Moody™ Wand</h1>
      </div>

      <div class="mt-16 -ml-35.7rem">
        <div>
