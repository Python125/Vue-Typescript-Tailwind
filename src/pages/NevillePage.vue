<template>
  <div>
    ...
    />
    <div class="neville-info flex ml-48rem">
      <div>
        <img :src="nevilleWand" alt="neville" class="w-96" />
        <div class="mt-0.5"></div>
      </div>
      <div class="ml-16">
        <h1 class="text-4xl text-center">Interactive Neville Longbottom™ Wand</h1>
      </div>

      <div class="mt-16 -ml-38.9rem">
        <div>
