<template>
  <div class="mcgonagall">
    <div class="mcgonagall-container">
      ...
      />
      <div class="mcgonagall-info">
        <div>
          <img :src="mcgonagallWand" alt="McGonagall" class="w-96" />
          <div class="mt-0.5"></div>
        </div>
        <div class="mcgonagall-title">
          <h1 class="text-4xl text-center">
            Interactive Professor McGonagall™ Wand
          </h1>
        </div>
        <div class="mcgonagall-price">
          <div class="text-custom-lightblue text-2xl font-bold">$65.00</div>
        </div>

        <form class="mcgonagall-quantity">
          <label for="quantity">Quantity </label>
          <input type="number" id="quantity" min="0" max="10" />
        </form>

        <div class="mcgonagall-link">
