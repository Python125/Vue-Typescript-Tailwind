<template>
  <div>
    ...
    />
    <div class="voldemort-info flex ml-48rem">
      <div>
        <img :src="voldemortWand" alt="voldemort" class="w-96" />
        <div class="mt-0.5"></div>
      </div>
      <div class="ml-16">
        <h1 class="text-4xl text-center">Interactive Voldemort™ Wand</h1>
      </div>

      <div class="mt-16 -ml-29.7rem">
        <div>
