<template>
  <div>
    ...
    />
    <div class="fred-info flex ml-48rem">
      <div>
        <img :src="fredWand" alt="fred" class="w-96" />
        <div class="mt-0.5"></div>
      </div>
      <div class="ml-16">
        <h1 class="text-4xl text-center">Interactive Fred Weasley™ Wand</h1>
      </div>

      <div class="mt-16 -ml-32.3rem">
        <div>
