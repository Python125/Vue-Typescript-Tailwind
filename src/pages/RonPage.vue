<template>
  <div>
    ...
    />
    <div class="ron-info flex ml-48rem">
      <div>
        <img :src="ronWand" alt="Ron" class="w-96" />
        <div class="mt-0.5"></div>
      </div>
      <div class="ml-16">
        <h1 class="text-4xl text-center">Interactive Ron Weasley™ Wand</h1>
      </div>

      <div class="mt-16 -ml-31.8rem">
        <div>
