<template>
  <div>
    ...
    />
    <div class="tonks-info flex ml-48rem">
      <div>
        <img :src="tonksWand" alt="tonks" class="w-96" />
        <div class="mt-0.5"></div>
      </div>
      <div class="ml-16">
        <h1 class="text-4xl text-center">Interactive Nymphadora Tonks™ Wand</h1>
      </div>

      <div class="mt-16 -ml-38.6rem">
        <div>
