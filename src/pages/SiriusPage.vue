<template>
  <div>
    ...
    />
    <div class="sirius-info flex ml-48rem">
      <div>
        <img :src="blackWand" alt="Sirius" class="w-96" />
        <div class="mt-0.5"></div>
      </div>
      <div class="ml-16">
        <h1 class="text-4xl text-center">Interactive Sirius Black™ Wand</h1>
      </div>

      <div class="mt-16 -ml-30.3rem">
        <div>
